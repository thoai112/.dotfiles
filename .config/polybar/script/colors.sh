...
RFILE="$HOME/.config/polybar/script/colors.rasi"
...
change_color() {
	...
	sed -i -e 's/foreground = #.*/foreground = #ECEFF4/g' $PFILE
	sed -i -e "s/m1 = #.*/m1 = $SH1/g" $PFILE
	sed -i -e "s/m2 = #.*/m2 = $SH2/g" $PFILE
	sed -i -e "s/m3 = #.*/m3 = $SH3/g" $PFILE
	sed -i -e "s/m4 = #.*/m4 = $SH4/g" $PFILE
	sed -i -e "s/m5 = #.*/m5 = $SH5/g" $PFILE
	sed -i -e "s/m6 = #.*/m6 = $SH6/g" $PFILE
	sed -i -e "s/m7 = #.*/m7 = $SH7/g" $PFILE
	sed -i -e "s/m8 = #.*/m8 = $SH8/g" $PFILE
